...
//    - Select the first `li` element inside the `ul` with class `topics` 
document.body.children[5].children[0];
and change the innerText to `all about document`
