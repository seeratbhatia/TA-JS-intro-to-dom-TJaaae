...
document.querySelectorAll('.seventeen').style.display = "none";

// Change the border of all the hr element from solid to dashed type
allHrsArray.forEach(elm => elm.style.borderstyle = "dashed");

// Create a pragraph element and store it in variable named 'para' using `createElement`
let para = document.createElemnt('p');
...
let box1 = docuent.query.Selector('.one');
box1.innerHTML = "";
...
console.log(box16.nextSibiling);
...
// Select box 2 and appeconsole.log(box16.parentElement);nd a new paragraph element with content "Append inserts as last child" just after hr element.
...
para2.innerText = "prepen inserts as first child";
...
imgElm.scr = "https://images.unsplash.com/photo-1592500595497-d1f52a40b207?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=80;
